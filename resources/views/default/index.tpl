	...
	<section id="subscribe" class="section-style" data-background-image="assets/public/images/background/contact.jpg">
		...
		<div class="container">
			<div class="contain-wrap">
				...
				<p class="section-description">
					Windows, Mac, Linux, Android, iOS, OpenWRT 跨平臺支持。
				</p><!-- /.section-description -->
				<br>
				<br>
				<div class="client-content">
					...
					<div class="row">
						...
						<div class="col-xs-4">
							<i class="fa fa-rss fa-flip-horizontal fa-4x"></i>
							<h3>OpenWRT</h3>
						</div>
					</div>
				</div>
...
<!-- 			<div class="next-section">
	...
	<!-- Modernizr js -->
	<script type="text/javascript" src="assets/public/js/modernizr-2.8.0.min.js"></script>
	<!-- Plugins -->
